      ...
      <div className="fixed bottom-6 left-6 z-50">
        ...
        {!isOpen && (
          <span className="absolute -top-1 -right-1 flex h-4 w-4">
            ...
            <span className="relative inline-flex rounded-full h-4 w-4 bg-foreground" />
          </span>
        )}
      </div>
          ...
          <div className="flex flex-col h-[500px] max-h-[70vh] rounded-2xl border border-border bg-background shadow-2xl overflow-hidden">
            ...
            <div className="flex items-center gap-3 px-4 py-3 bg-primary text-primary-foreground">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-primary-foreground/70">Ask me about Bikash</p>
              </div>
              <Button
                variant="ghost"
                size="icon"
            ...
            <form onSubmit={handleSubmit} className="p-3 border-t border-border">
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 rounded-full border border-input bg-background px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-ring text-foreground placeholder:text-muted-foreground"
                  disabled={isTyping}
                />
                <Button
                  type="submit"
